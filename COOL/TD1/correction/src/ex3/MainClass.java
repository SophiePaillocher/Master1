...
public class MainClass 
{
	public static void main(String[] args) 
	{
		...
		TemperatureSensor ts1 = new DefaultTemperatureSensor("Salon");
		TemperatureSensor ts2 = new DefaultTemperatureSensor("Cave");
		TemperatureSensor ts3 = new ThermometerAdapter("Jardin", 4);
